                        ...
                        <div class="col-sm-4 col-md-2 col-lg-10 order-3 order-lg-2">
                            <div class="mainmenu__wrap">
                                <nav class="mainmenu__nav">
                                    <ul class="mainmenu">
                                        <?php /* if ($user[0]->school_name != '') { ?>
												<li class=""><a href="#" style="color: #89d700;font-weight: 800;padding-right: 30px;padding-top: 5px;font-size: 16px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width: 443px;"> <span style="text-transform: uppercase;color:#89d700;"> <span style="text-transform: uppercase;color:#89d700;"> &nbsp;<?= $user[0]->school_name ?></span></a></li>
											<?php } */ ?>
                                        <!-- <li class="active"><a href="dashboard">Home</a></li> -->
                                        <!--<li class=""><a href="helps">Help</a></li>-->
                                        <!-- <li class=""><a href="logout">Logout</a></li> -->
                                        <!-- <li class=""><a href="profile">Profile</a></li> -->
                                        <?php /* if ($user[0]->teacher_code != '') { ?>
												<li class=""><a href="#" style="color:#89d700;font-weight:600;">Teacher Code : <span style="text-transform: uppercase;color:#ff9900;"> &nbsp;<?= $user[0]->teacher_code ?></span></a></li>
											<?php } */ ?>
                                        <li><a href="profile" class="spe-us">
                                                <?php /* if (empty($user[0]->dp)) { ?>
														<img src="assets/img/3.png" alt="logo images">
													<?php } else { ?>
														<img src="assets/img/<?= $user[0]->dp ?>" alt="logo images">
														Hi,&nbsp; <b class="ss-pp"><?= $user[0]->fullname ?></b></a>
														<?php } */ ?>
                                                &nbsp;
                                                Hi,&nbsp; <b class="ss-pp">Visitor!</b></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
