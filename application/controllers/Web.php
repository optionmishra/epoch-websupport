...
class Web extends CI_Controller
{
    ...
    public function index($msg = null)
    {
        if (
            isset($_ENV["AUTH"]) &&
            !filter_var($_ENV["AUTH"], FILTER_VALIDATE_BOOLEAN)
        ) {
    ...
    public function dashboard()
    {
        ...
        $data = [
            ...
            "selectable_subjects" => $this->AuthModel->msubject_mod(
                $this->WebModel->Webuser()->subject,
            ),
            "selectable_classes" => $this->AuthModel->selectable_classes(
                $this->session->userdata("main_subject"),
            ),
            ...
            "selectable_categories" => $this->session->userdata("selected_book")
                ? $this->AuthModel->get_categories(
                    $this->session->userdata("selected_book"),
                )
                : [],
    ...
    public function test_assign()
    {
        if (!$this->session->userdata("username")) {
            ...
            $data = [
                ...
                "user" => $this->WebModel->Webuser(),
                "assigntest" => $this->AuthModel->assigntest(
                    $this->session->userdata("teacher_code"),
                ),
    ...
    public function student_panel()
    {
        if (!$this->session->userdata("username")) {
            ...
            $data = [
                ...
                "copyright" => $this->AuthModel->content("Copyright"),
                "user" => $this->WebModel->Webuser(),
                "classes" => $this->AuthModel->classes_teacher(
                    $this->session->userdata("classes"),
                ),
    ...
    public function view_subjective_paper()
    {
        if (!$this->session->userdata("username")) {
            ...
            $summative = $this->AuthModel->summativeQuestion_solved_for_view(
                $student_id,
                $paper_mode,
            );
    ...
    public function view_objective_paper()
    {
        if (!$this->session->userdata("username")) {
            ...
            $objective = $this->AuthModel->objectiveQuestion_solved(
                $id,
                $paper_mode,
            );
