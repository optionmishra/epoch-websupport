...
//            $this->message('success', 'file Uploaded');
    ...
    public function check_forgot()
    {
        ...
        $res = $this->AuthModel->val_email($recipient);

        if (! $res) {
            $this->message('error', 'Email is not registered with us, Please Retry!');
        } else {
            $data = [
                'email' => $recipient,
            ...
            if (! $this->email->send()) {
                ...
                $this->message('success', 'Your Password was sent to your registered email, Please check your inbox.');
            }
        }
    }
