...
class Admin_master extends CI_Controller
{
    ...
    private function upload_file($file_name, $path, $field_name)
    {
        ...
        $config["allowed_types"] =
            "gif|jpg|png|jpeg|mp4|3gp|flv|svg|webp|wmv|ico|xlsx|doc|docx|pdf|zip|rar|ini|csv";
        $config["max_size"] = 0;
    ...
    public function users()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a user_id='" .
                $value->id .
                "' class='pr-2 pointer edit-user' href='superadmin/user_update/" .
                $value->id .
                "'><i class='fa fa-edit'></i></a>" .
                "<a user_id='" .
                $value->id .
                "' class='pointer delete_user'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_user()
    {
        if ($this->permission->is_allow("New User")) {
            ...
            $this->email->cc(
                "mayank@epochstudio.net, newagekids@newagepublishers.com, " .
                    $this->siteEmail,
            );
            $this->email->subject(
                "Your Credentials for " . $this->siteName . " Web Support",
            );
            $this->email->message(
                $this->load->view("web/email_template1", $data, true),
            );
            $this->email->send();
            ...
            $this->message(
                "success",
                $this->input->post("name") . " User Create Successfully....",
            );
        } else {
    ...
    public function salesman()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a salesman_id='" .
                $value->id .
                "' class='pr-2 pointer edit-salesman' href='#" .
                $value->id .
                "'><i class='fa fa-edit'></i></a>";
            $i++;
        }
    ...
    public function add_contact()
    {
        ...
        $this->email->subject(
            "New Contact Message from " . $this->siteName . " Web Support",
        );
    ...
    public function update_user()
    {
        if ($this->permission->is_allow("Update User")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " User Update Successfully....",
            );
        } else {
            $this->message("error", "Permission Denied.......");
        }
        ...
        if ($this->permission->is_allow("Update User")) {
            ...
            foreach ($sub_arr as $sub) {
                ...
                foreach ($sub_series_arr as $sub_series) {
                    ...
                    $series_classes[$sub][$sub_series] = $this->input->post(
                        $sub_series . "Classes",
                    );
                    $classes = array_merge(
                        $classes,
                        $this->input->post($sub_series . "Classes"),
                    );
                }
            }
    ...
    public function conts()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a cont_id='" .
                $value->id .
                "' class='pr-2 pointer edit-cont' data-toggle='modal' data-target='#edit-cont'><i class='fa fa-edit'></i></a>" .
                "<a cont_id='" .
                $value->id .
                "' class='pointer delete_cont'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_cont()
    {
        if ($this->permission->is_allow("New Content")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Content Create Successfully....",
            );
        } else {
            $this->message("error", "Permission Denied.......");
        }
    ...
    public function update_cont()
    {
        if ($this->permission->is_allow("Update Content")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Content Update Successfully....",
            );
        } else {
            $this->message("error", "Permission Denied.......");
        }
    ...
    public function permissions()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a permission_id='" .
                $value->id .
                "' class='pr-2 pointer edit-permission' data-toggle='modal' data-target='#edit-permission'><i class='fa fa-edit'></i></a>" .
                "<a permission_id='" .
                $value->id .
                "' class='pointer delete_permission'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_permission()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " Permission Create Successfully....",
        );
    }
    ...
    public function update_permission()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " Permission Update Successfully....",
        );
    }
    ...
    public function states()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a state_id='" .
                $value->StateID .
                "' class='pr-2 pointer edit-state' data-toggle='modal' data-target='#edit-state'><i class='fa fa-edit'></i></a>" .
                "<a state_id='" .
                $value->StateID .
                "' class='pointer delete_state'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_state()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " state Create Successfully....",
        );
    }
    ...
    public function update_state()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " state Update Successfully....",
        );
    }
    ...
    public function webu()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a webu_id='" .
                $value->id .
                "' class='pr-2 pointer edit-webu' data-toggle='modal' data-target='#edit-webu'><i class='fa fa-edit'></i></a>" .
                "<a webu_id='" .
                $value->id .
                "' title='Block' class='pr-2 pointer status_webu'><i class='fa fa-times text-danger'></i></a>" .
                "<a webu_id='" .
                $value->id .
                "' title='Unblock' class='pr-2 pointer statuss_webu'><i class='fa fa-check text-success'></i></a>" .
                "<a webu_id='" .
                $value->id .
                "' class='pointer delete_webu'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function webu_teacher()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a user_id='" .
                $value->id .
                "' class='pr-2 pointer edit-user' href='superadmin/teacher_update/" .
                $value->id .
                "'><i class='fa fa-edit'></i></a>" .
                "<a webu_id='" .
                $value->id .
    ...
    public function select_emp()
    {
        ...
        $this->email->message(
            $this->load->view("web/cemail_template", $data, true),
        );
        $this->email->send();
        if (!$res) {
            $this->message("error", $this->AuthModel->error);
    ...
    public function delete_webu()
    {
        if ($this->permission->is_allow("Delete Web Support User")) {
            ...
            $this->message(
                "success",
                "Web Support User Deleted Successfully....",
            );
        } else {
            $this->message("error", "Permission Denied.......");
        }
    ...
    public function boards()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a board_id='" .
                $value->id .
                "' class='pr-2 pointer edit-board' data-toggle='modal' data-target='#edit-board'><i class='fa fa-edit'></i></a>" .
                "<a board_id='" .
                $value->id .
                "' class='pointer delete_board'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_board()
    {
        if ($this->permission->is_allow("New Board")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Board Create Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function update_board()
    {
        if ($this->permission->is_allow("Update Board")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Board Update Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function publications()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a publication_id='" .
                $value->id .
                "' class='pr-2 pointer edit-publication' data-toggle='modal' data-target='#edit-publication'><i class='fa fa-edit'></i></a>" .
                "<a publication_id='" .
                $value->id .
                "' class='pointer delete_publication'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_publication()
    {
        if ($this->permission->is_allow("New Publication")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") .
                    " Publication Create Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function categorys()
    {
        ...
        foreach ($res as $key => &$value) {
            $value->orders =
                "<select category_id='" .
                $value->id .
                "' class='edit-categoryss' name='cat'><option value='" .
                $value->orderb .
                "' selected disabled>" .
                $value->orderb .
            ...
            $value->action =
                "<a category_id='" .
                $value->id .
                "' class='pr-2 pointer edit-category' data-toggle='modal' data-target='#edit-category'><i class='fa fa-edit'></i></a>" .
                "<a category_id='" .
                $value->id .
                "' class='pointer delete_category'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function summativeQuestion()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a summativeQuestion_id='" .
                $value->id .
                "' class='pr-2 pointer summative-QuestionEdit' data-toggle='modal' data-target='#summative-QuestionEdit'><i class='fa fa-edit'></i></a>" .
                "<a summativeQuestion_id='" .
                $value->id .
                "' class='pointer summativeQuestionDelete'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_summativeQuestion()
    {
        if ($this->permission->is_allow("New Subject")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Subject Create Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function objectiveQuestion()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->class = "Class" . $value->class;
            $value->action =
                "<a objectiveQuestion_id='" .
                $value->id .
                "' class='pr-2 pointer objective-QuestionEdit' data-toggle='modal' data-target='#objective-QuestionEdit'><i class='fa fa-edit'></i></a>" .
                "<a objectiveQuestion_id='" .
                $value->id .
                "' class='pointer objectiveQuestionDelete'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function msubjects()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a msubject_id='" .
                $value->id .
                "' class='pr-2 pointer medit-subject' data-toggle='modal' data-target='#medit-subject'><i class='fa fa-edit'></i></a>" .
                "<a msubject_id='" .
                $value->id .
                "' class='pointer mdelete_subject'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function mupdate_subject()
    {
        if ($this->permission->is_allow("Update Subject")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Subject Update Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function subjects()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a subject_id='" .
                $value->id .
                "' class='pr-2 pointer edit-subject' data-toggle='modal' data-target='#edit-subject'><i class='fa fa-edit'></i></a>" .
                "<a subject_id='" .
                $value->id .
                "' class='pointer delete_subject'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function series()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a series_id='" .
                $value->id .
                "' class='pr-2 pointer edit-series' data-toggle='modal' data-target='#edit-series'><i class='fa fa-edit'></i></a>" .
                "<a series_id='" .
                $value->id .
                "' class='pointer delete_series'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_series()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " Series Added Successfully.",
        );
        // } else {
        // $this->message('error', 'permission Denied.......');
        // }
    ...
    public function update_series()
    {
        ...
        $this->message(
            "success",
            $this->input->post("name") . " Series Updated Successfully.",
        );
    }
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "" .
                    "<a assigntest_id='" .
                    $value->id .
                    "' class='pointer delete_assigntest'><i class='fa fa-trash text-danger'></i></a>" <
    ...
    public function add_assigntest()
    {
        ...
        $res = $this->AuthModel->check_assign_paper(
            $teacher_code,
            $class,
            $section,
            $paper_code,
        ...
        if ($res) {
            ...
            if (!$res) {
                $this->session->set_flashdata(
                    "error",
                    "Some thing wrong! Plese try again.",
                );
                redirect("web/test_assign");
            }
            $this->session->set_flashdata(
                "success",
                $this->input->post("name") . " Test Assigned Successfully.",
            );
            redirect("web/test_assign");
        } else {
            $this->session->set_flashdata(
                "error",
                "Assigned test already exists.",
            );
            redirect("web/test_assign");
        }
    }
        ...
        if ($this->session->userdata("type") == "Teacher") {
            ...
            switch ($active_test_data["paper_mode"]) {
                case "11":
                    $result_data = [
                        ...
                        "stu_teacher_code" => $this->session->userdata(
                            "teacher_code",
                        ),
                    ];
                    break;
            ...
            foreach ($students as $student) {
                ...
                if ($has_result) {
                    ...
                    $result_inserted = $this->db->insert(
                        "result",
                        $result_data2,
                    );
                    // if ($result_inserted) {
        ...
        if ($objective) {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                $data = [
                    ...
                    "student_code" => $this->session->userdata(
                        "stu_teacher_code",
                    ),
    ...
    public function classesSection()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a classesSection_id='" .
                $value->id .
                "' class='pr-2 pointer edit-classesSection' data-toggle='modal' data-target='#edit-classesSection'><i class='fa fa-edit'></i></a>" .
                "<a classesSection_id='" .
                $value->id .
                "' class='pointer delete_classesSection'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_classesSection()
    {
        if ($this->permission->is_allow("New Classes")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") .
                    " Class Section Create Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function update_classesSection()
    {
        if ($this->permission->is_allow("Update Classes")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") .
                    " Class Section Update Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function classess()
    {
        ...
        foreach ($res as $key => &$value) {
            ...
            $value->action =
                "<a classes_id='" .
                $value->id .
                "' class='pr-2 pointer edit-classes' data-toggle='modal' data-target='#edit-classes'><i class='fa fa-edit'></i></a>" .
                "<a classes_id='" .
                $value->id .
                "' class='pointer delete_classes'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
    ...
    public function add_classes()
    {
        if ($this->permission->is_allow("New Classes")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Classes Create Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function update_classes()
    {
        if ($this->permission->is_allow("Update Classes")) {
            ...
            $this->message(
                "success",
                $this->input->post("name") . " Classes Update Successfully....",
            );
        } else {
            $this->message("error", "permission Denied.......");
        }
    ...
    public function support()
    {
        ...
        foreach ($res as $key => &$value) {
            $value->check =
                '<input type="checkbox" class="form-control-custom" name="checkDelete" value="' .
                $value->id .
                '">';
            $value->sr_no = $i;
            $value->action =
                "<a support_id='" .
                $value->id .
                "' class='pr-2 pointer edit-support' href='superadmin/support_update/" .
                $value->id .
                "'><i class='fa fa-edit'></i></a>" .
                "<a support_id='" .
                $value->id .
                "' class='pointer delete_support'><i class='fa fa-trash text-danger'></i></a>";
            $i++;
        }
...
//            $this->message('success', 'file Uploaded');
    ...
    public function update_support()
    {
        $id = $this->input->post("id");
        $file_url =
            $this->input->post("upload_type") == "file"
                ? ""
                : $this->input->post("support_url");
        if (
            !$_FILES["support_image"]["size"] &&
            !$_FILES["support_icon"]["size"]
        ) {
            $states = implode(",", $this->input->post("states"));
            $data = [
                "title" => $this->input->post("title"),
    ...
    public function upload_video($file_name)
    {
        $this->upload->initialize([
            "upload_path" => "files/",
            "allowed_types" =>
                "gif|jpg|png|jpeg|mp4|3gp|flv|svg|webp|wmv|ico|docx|xlsx|doc|docs|pdf|zip|rar",
            "max_size" => 0,
            "file_name" => $file_name,
        ]);
    ...
    public function add_student_custom()
    {
        ...
        if (empty($check_tu) || $check_tu === "limit_exhausted") {
            ...
            if (empty($check_tu)) {
                $this->session->set_flashdata(
                    "error",
                    "Invalid Teacher Code! Registration completed without teacher code.",
                );
            } else {
                $this->session->set_flashdata(
                    "error",
                    "Teacher Code has reached its limit! Registration completed without teacher code.",
                );
            }
        } else {
        ...
        if (!empty($existing_user)) {
            ...
            $success_message =
                "Your registration has been updated successfully. Please check your registered email for your account credentials.";
        } else {
            // Insert new record
            $res = $this->db->insert("web_user", $user_data);
            $success_message =
                "You are successfully registered with us. Please check your registered email for your account credentials.";
        }
        ...
        if ($res) {
            ...
            $this->email->message(
                $this->load->view("web/email_template", $data, true),
            );
            $this->email->send();
    ...
    public function add_teacher_custom()
    {
        ...
        if (!empty($check)) {
            $this->session->set_flashdata(
                "error",
                "The email provided is already registered. Please use a different email.",
            );
            ...
            if (empty($this->input->post("series"))) {
                $this->session->set_flashdata(
                    "error",
                    "Please select at least one series! Registration Failed.",
                );
                redirect("" . "/teacher-registration");
            }
            // series - classes
    ...
    public function default_product()
    {
        ...
        $this->session->set_userdata(
            "class_name",
            $this->AuthModel->get_class($selectedClasses)->name,
        );
    ...
    public function default_product_old()
    {
        ...
        $this->session->set_userdata(
            "board",
            $this->input->post("select_board"),
        );
        $this->session->set_userdata(
            "publication",
            $this->input->post("select_publication"),
        );
        ...
        $this->session->set_userdata(
            "classes",
            $this->input->post("select_classes"),
        );
        $this->session->set_userdata(
            "msubject",
            $this->input->post("select_msubject"),
        );
    ...
    public function change_product2()
    {
        ...
        $this->session->set_userdata(
            "class_name",
            $this->AuthModel->get_class($classes)->name,
        );
    ...
    public function get_sectionclass()
    {
        ...
        foreach ($results as $key => $result) {
            ...
            $row .=
                ...
                $result->class .
                "" .
                $class_section_array[$result->section] .
                "</td>";
            // objective tests
            $row .=
            ...
            if ($result->obj_1 && $result->obj_1 != "N/A") {
                ...
                $row .=
                    '<a class="mx-2 btn btn-sm btn-success" href="' .
                    base_url() .
                    "web/view_objective_paper/" .
                    $result->student_id .
                    "/" .
                    "11" .
                    '" target="_blank">View</a><span class="gray-box">' .
                    $result->obj_1;
                $row .= "</span></div>";
            } elseif ($result->obj_1 == "N/A") {
                $row .= '<div class="my-1"><span>Objective Test 1</span>';
                $row .=
                    '<span class="mx-2 btn btn-sm btn-danger" title="Test Not Attempted">N/A</span>';
                $row .= "</span></div>";
            }
            ...
            if ($result->obj_1_dt) {
                $row .=
                    '<div class="my-1"><span class="gray-box">' .
                    $result->obj_1_dt .
                    "</div>";
            }
            if ($result->obj_2_dt) {
            ...
            if (
                $result->sub_1 &&
                $result->sub_1 != "N/A" &&
                $result->sub_1 != "Submitted"
            ) {
                $row .= '<div class="my-1"><span>Subjective Test 1</span>';
                $row .=
                    '<a class="mx-2 btn btn-sm btn-success" href="' .
                    base_url() .
                    "web/view_subjective_paper/" .
                    $result->student_id .
                    "/" .
                    "21" .
                    '" target="_blank">View</a><span class="gray-box">' .
    ...
    public function check_forgot()
    {
        ...
        if (!$res) {
            $this->message(
                "error",
                "Email is not registerd with us, Please Retry!",
            );
        } else {
            $data = [
                "email" => $email,
            ...
            $this->email->from($this->siteEmail, $this->siteName);
            $this->email->subject(
                "Your Password for " . $this->siteName . " Web Support",
            );
            $this->email->message(
                $this->load->view("web/email_template2", $data, true),
            );
            $this->email->send();
            $this->message(
                "success",
                "Your Password Sent on your registerd email, Please check your email inbox. Thank You....",
            );
        }
    }
    ...
    public function teacher_reference()
    {
        if (!$this->session->userdata("username")) {
            ...
            if ($res) {
                $this->message(
                    "success",
                    "You are Successfully submit your question with us!Thanks.",
                );
            }
            redirect("dashboard");
        }
    ...
    public function csvToArray(
        ...
        if ($header) {
            ...
            $headingsArray = $objWorksheet->rangeToArray(
                "A1:" . $highestColumn . "1",
                null,
                true,
                true,
            ...
            for ($row = 2; $row <= $highestRow; $row++) {
                $dataRow = $objWorksheet->rangeToArray(
    ...
    public function upload_questions()
    {
        ...
        if (!$this->upload->do_upload("questions_file")) {
            ...
            $questions_data = $this->csvToArray(
                "assets/question_files/" . $file_name . ".csv",
            );
    ...
    public function upload_and_generate_csv()
    {
        ...
        $complete_file_name = str_replace(
            " ",
            "_",
            $time . $file_name . "." . strtolower($file_extension),
        );

        // for icons zip
        $file_extension2 = pathinfo(
            $_FILES["icon_files"]["name"],
            PATHINFO_EXTENSION,
        );
        $file_name2 = pathinfo(
            $_FILES["icon_files"]["name"],
        ...
        $complete_file_name2 = str_replace(
            " ",
            "_",
            $time . $file_name2 . "." . strtolower($file_extension2),
        );

        if (
            $this->upload_file($complete_file_name, $path, "support_files") &&
            $this->upload_file($complete_file_name2, $path, "icon_files")
        ) {
            $zip = new ZipArchive();
            if ($zip->open("$path/$complete_file_name") === true) {
                ...
                $this->message(
                    "error",
                    "Error occurred in processing $file_name.",
                );
            }
            ...
            if ($zip2->open("$path/$complete_file_name2") === true) {
                ...
                $this->message(
                    "error",
                    "Error occurred in processing $file_name2.",
                );
            }
        } else {
        ...
        foreach ($extracted_files_arr as $key => $extracted_file_name) {
            ...
            array_push($csv_file_data, [
                ...
                empty($extracted_icons_arr[$key])
                    ? $extracted_icons_arr[0]
                    : $extracted_icons_arr[$key],
                $data["description"],
    ...
    {
        $path =
            "assets/batch_support_upload/" .
            $this->session->userdata("batch_upload_id") .
            "/";

        // for files zip
        $file_extension = pathinfo(
            $_FILES["updated_csv_file"]["name"],
            PATHINFO_EXTENSION,
        );
        $file_name = pathinfo(
            $_FILES["updated_csv_file"]["name"],
        ...
        $complete_file_name = str_replace(
            " ",
            "_",
            $file_name . "." . strtolower($file_extension),
        );

        if (
            $this->upload_file($complete_file_name, $path, "updated_csv_file")
        ) {
    ...
    public function batch_support_upload_final_submit()
    {
        ...
        foreach ($upload_data as $row) {
            ...
            rename(
                $path . "files/" . $row["Support File"],
                "assets/files/$batch_upload_id" . $row["Support File"],
            );
            copy(
                $path . "icons/" . $row["Icon File"],
                "assets/bookicon/$batch_upload_id" . $row["Icon File"],
            );
    ...
    public function simpleStudentRegistration()
    {
        ...
        if (!$res) {
            $this->session->set_flashdata(
                "error",
                "Something is wrong! Your are not registerd",
            );
