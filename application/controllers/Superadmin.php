...
class Superadmin extends CI_Controller
{
    ...
    public function web_user_teacher()
    {
        if ($this->session->userdata('level') == 'Super Admin') {
            $this->check_isvalidated();
            $data = [
    ...
    public function objectQuestion()
    {
        if ($this->session->userdata('level') == 'Super Admin') {
            $this->check_isvalidated();
            $data = [
    ...
    public function classess_section()
    {
        if ($this->session->userdata('level') == 'Super Admin') {
            $this->check_isvalidated();
            $data = [
    ...
    public function batch_upload_instructions()
    {
        if ($this->session->userdata('level') == 'Super Admin') {
            $this->check_isvalidated();
            $data = [
